...
static char bootargs_recovery[] = "set bootargs root=/dev/mmcblk1p8 rw rootwait mem=640M console=ttyS0,115200 init=/init";
...
static char bootargs_charge[] = "set bootargs root=/dev/mmcblk1p2 rw rootwait mem=640M console=ttyS0,115200 init=/init androidboot.mode=charger";
...
#ifdef CONFIG_FASTBOOT_RECOVERY //padÀïÍ·²ÅÓÐ
...
{
	printf("read hdmi resolution from ext4 mmc 1:5 0x80007fc0");
	char *mem = (char*)0x80007fc0;
	//ÒªÈ¥¶ÁÈ¡Õâ¸öext4·ÖÇøÃ´å
	char *ext4_load[5]  = { "do_ext4_load","mmc","1:5","0x80007fc0", "property/persist.sys.hdmi.mode", };
	int load_cfg = -1;
	int filesize;
	printf("read mmc count from 0x0704e04c");
