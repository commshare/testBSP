...
#define CONFIG_NS115_PAD_PROTOTYPE
...
#define CONFIG_SYS_PROMPT	"NS115_PAD_PROTOTYPE # "
#define CONFIG_IDENT_STRING "\n\n***  NS115 PAD PROTOTYPE Board V1.9***\n\n"
...
#define CONFIG_EXTRA_ENV_SETTINGS      \
       ...
       "default_bootargs=setenv bootargs console=ttyS0,115200 pmem=${pmem_base} root=/dev/mmcblk1p2 rw rootwait mem=824M batt=${volt_buff} video=nusmartfb:${resolution}-${dispformat} init=/init wifiethaddr=${wifimac}\0" \
...
#define CONFIG_EXTRA_ENV_SETTINGS 								 \
	...
	"tfargs=" 										 \
		...
		"video=nusmartfb:${resolution}-${dispformat} " 					 \
		"root=/dev/mmcblk0p2 " 								 \
		"rw rootwait mem=776M init=/init;bootm \0"					 \
	"emmcargs=" 										 \
		"setenv bootargs console=ttyS0,115200 " 					 \
		"video=nusmartfb:${resolution}-${dispformat} " 					 \
		"root=/dev/mmcblk1p2 " 								 \
...
#define AC_CHG_CURRENT	1200//mA
#define BATT_MAX_MAH	3000//mAh
#define BATT_RESISTOR 100//mohm
#define USB_CHG_CURRENT	500//mA
#define USB_GPIO_RICOH583
#define USB_CHG_GPIO 4
#define USB_CHG_GPIO_EFFECT 1
#define SYS_CONSUMPTION 1065//mW
#define CHARGER_NO_DELAY  1
