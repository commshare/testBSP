...
//By James
//#define CONFIG_DUAL_DISPLAY

#if defined(CONFIG_DUAL_DISPLAY)
#define CONFIG_NUSMART_CH7026
//#define CONFIG_NUSMART_CS8556
#define CONFIG_LCD_SLAVE_PAL
//#define CONFIG_LCD_SLAVE_NTSC
//#define CONFIG_LCD_SLAVE_1024_600_60
//#define CONFIG_LCD_SLAVE_800_600_60
#endif

//#define CONFIG_NS115_1280X720_LOGO
//#define CONFIG_NS115_HDMI
...
#define CONFIG_EXTRA_ENV_SETTINGS       \
	"dispformat=32\0"       \
	"pmem_base=0x98600000\0" \
        "splashimage=0x80007fc0\0"      \
        "bootcmd=run default_bootargs;ext4load mmc 1:2 0x80007fc0 uImage;ns115 cpu volt 1230000;bootm\0"       \
        "default_bootargs=setenv bootargs console=ttyS0,115200 pmem=${pmem_base} root=/dev/mmcblk1p2 rw rootwait mem=390M vpumem=106M fbmem=16M gc300mem=0M batt=${volt_buff} video=nusmartfb:1280x720-${dispformat} init=/init wifiethaddr=${wifimac} usbethmac=${ethmac}\0" \
...
#define CONFIG_EXTRA_ENV_SETTINGS       \
	...
	"pmem_base=0xb3800000\0" \
        ...
        "default_bootargs=setenv bootargs console=ttyS0,115200 pmem=${pmem_base} root=/dev/mmcblk1p2 rw rootwait mem=824M fbmem=64M init=/init video=nusmartfb:${lcdres} wifiethaddr=${wifimac} usbethmac=${ethmac}\0" \
        "mmcupdate=fatload mmc 0:1 0x80007fc0 mmc_update;autoscr 0x80007fc0\0"  \
        "usbupdate=fatload usb 0:1 0x80007fc0 usb_update;autoscr 0x80007fc0\0"  \
	"poweroff_volt=3200\0"							\
	"poweroff_lcd=3200\0"							\
...
#define CONFIG_ENV_END_ADDR          4600 //just for saveenv command
