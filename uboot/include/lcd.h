...
extern struct vidinfo panel_info_2;

extern void lcd_ctrl_init (void *lcdbase);
extern void lcd_enable (void);
#ifdef CONFIG_NUSMART_LCD
extern void lcd_newline(void * row_sec, int scroll_size);
#endif
...
#elif defined(CONFIG_ATMEL_LCD)||defined(CONFIG_NUSMART_LCD)
