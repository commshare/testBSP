...
#define TL7689_EFUSE_BASE  0x06160000

#define TL7689_EFUSE_CEN   	(0x0104)
#define TL7689_EFUSE_REQ   	(0x0108)
#define TL7689_EFUSE_ADDR  	(0x010c)
#define TL7689_EFUSE_DATA_0	(0x0110)
#define TL7689_EFUSE_DATA_1  (0x0114)
