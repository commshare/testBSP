 ...
 *gsensor kxud9
 */
struct i2c_board_info __initdata tl7689_gs_kxud9 =
{
 ...
 * gsensor kxtj9-1005
 */
struct i2c_board_info __initdata tl7689_gs_kxtj9 =
{
	I2C_BOARD_INFO("kxtj9", KXTJ9_I2C_ADDR),
	.platform_data	= &kxtj9_pdata,
	.irq		= IRQ_TL7689_GPIO1_INTR25,
};
#endif
 ...
 *lightsensor cm3212
 */
struct i2c_board_info __initdata tl7689_ls_cm3212 =
{
	I2C_BOARD_INFO("cm3212", 0x90/2),
};


struct touch_panel_platform_data tl7689_tp_platform_data =
{
	.irq_reset = IRQ_TL7689_GPIO1_INTR7,
};

/*
 *touch screen
 */
struct i2c_board_info __initdata tl7689_tp_goodix =
{
	I2C_BOARD_INFO("Goodix-TS", 0x55),
	.platform_data	= &tl7689_tp_platform_data,
	.irq		= IRQ_TL7689_GPIO1_INTR6,
};

struct i2c_board_info __initdata tl7689_tp_sis =
{
	I2C_BOARD_INFO("sis_i2c_ts", 0x05),
	.irq = IRQ_TL7689_GPIO1_INTR2,
};

struct i2c_board_info __initdata tl7689_tp_zt2083 =
{
 ...
 */
struct i2c_board_info __initdata tl7689_tp_ilitek =
{
 ...
 *io373x
 */
struct i2c_board_info __initdata tl7689_ec_io373x =
{
	I2C_BOARD_INFO("io373x-i2c", 0xc4/2),
	.irq = IRQ_TL7689_GPIO1_INTR1,
};

/*
 *sound alc5631
 */
struct i2c_board_info __initdata tl7689_snd_alc5631 =
{
 ...
 *sound wm8960
 */
struct i2c_board_info __initdata tl7689_snd_wm8960 =
{
 ...
 *hdmi 7033
 */
struct i2c_board_info __initdata tl7689_hdmi_7033 =
{
 ...
 *hdmi 7033 audio
 */
struct i2c_board_info __initdata tl7689_hdmi_7033_audio =
{
 ...
 */
struct i2c_board_info __initdata tl7689_cs_ami30x =
{
	I2C_BOARD_INFO("ami30x", 0x0e),
	.irq = IRQ_TL7689_GPIO1_INTR24,
};
#endif
