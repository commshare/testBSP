/*
 *  linux/arch/arm/mach-ns115/get_bootargs.c
 *
 *  ns115 get bootargs
 *
 *  Author:	jinying wu
...
static unsigned long gc300_mem_len= 0x00800000;  //8M
static unsigned long vpu_mem_len = 0x0a000000;	//160M
static unsigned long zsp_mem_len = 0x00000000;	//8M
#ifdef CONFIG_MACH_NS115_STICK
static unsigned long gpu_mem_len = 0x16400000;	//356M
#else
