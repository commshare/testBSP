...
#define PRCM_SYS_PWR_CTRL           ((PRCM_BASE) + 0x08)
#define PRCM_NUSTAR_PWR_CTRL        ((PRCM_BASE) + 0x0C)
#define PRCM_SYS_PWR_STATUS         ((PRCM_BASE) + 0x10)
#define PRCM_WAKEUP_IRQ_CTRLk       ((PRCM_BASE) + 0x14)
#define PRCM_ACK_ISO                ((PRCM_BASE) + 0x18)
//                                  ((PRCM_BASE) + 0x1C)
#define PRCM_MISC_REG0              ((PRCM_BASE) + 0x20)
#define PRCM_MISC_REG1              ((PRCM_BASE) + 0x24)
#define PRCM_MISC_REG2              ((PRCM_BASE) + 0x28)
#define PRCM_MISC_REG3              ((PRCM_BASE) + 0x2C)
//                                  ((PRCM_BASE) + 0x30)
//                                  ((PRCM_BASE) + 0x34)
#define PRCM_SYS_PLL_CTRL           ((PRCM_BASE) + 0x38)
#define PRCM_SYS_PLL_STATUS         ((PRCM_BASE) + 0x3C)
#define PRCM_PLL0_CFG0              ((PRCM_BASE) + 0x40)
#define PRCM_PLL0_CFG1              ((PRCM_BASE) + 0x44)
#define PRCM_PLL1_CFG0              ((PRCM_BASE) + 0x48)
#define PRCM_PLL1_CFG1              ((PRCM_BASE) + 0x4C)
#define PRCM_PLL2_CFG0              ((PRCM_BASE) + 0x50)
#define PRCM_PLL2_CFG1              ((PRCM_BASE) + 0x54)
#define PRCM_PLL3_CFG0              ((PRCM_BASE) + 0x58)
#define PRCM_PLL3_CFG1              ((PRCM_BASE) + 0x5C)
#define PRCM_PLL4_CFG0              ((PRCM_BASE) + 0x60)
#define PRCM_PLL4_CFG1              ((PRCM_BASE) + 0x64)
...
//                                  ((PRCM_BASE) + 0x78)
//                                  ((PRCM_BASE) + 0x7C)
#define PRCM_CPU_CLK_DIV            ((PRCM_BASE) + 0x80)
#define PRCM_CPU_CLK_SWITCH         ((PRCM_BASE) + 0x84)
#define PRCM_CORESIGHT_CLK_CTRL     ((PRCM_BASE) + 0x88)
#define PRCM_DDR_CLK_CTRL           ((PRCM_BASE) + 0x8C)
#define PRCM_BUS_CLK_CTRL           ((PRCM_BASE) + 0x90)
#define PRCM_DMA_CLK_CTRL           ((PRCM_BASE) + 0x94)
#define PRCM_MALI_CLK_CTRL          ((PRCM_BASE) + 0x98)
#define PRCM_GC300_CLK_CTRL         ((PRCM_BASE) + 0x9C)
#define PRCM_VPU_G1_CLK_CTRL        ((PRCM_BASE) + 0xA0)
#define PRCM_VPU_H1_CLK_CTRL        ((PRCM_BASE) + 0xA4)
#define PRCM_ISP_CLK_CTRL           ((PRCM_BASE) + 0xA8)
#define PRCM_SD_CLK_CTRL            ((PRCM_BASE) + 0xAC)
#define PRCM_ZSP_CLK_CTRL           ((PRCM_BASE) + 0xB0)
#define PRCM_SPI_CLK_CTRL           ((PRCM_BASE) + 0xB4)
#define PRCM_I2C_CLK_CTRL           ((PRCM_BASE) + 0xB8)
#define PRCM_UART_CLK_CTRL0         ((PRCM_BASE) + 0xBC)
#define PRCM_UART_CLK_CTRL1         ((PRCM_BASE) + 0xC0)
#define PRCM_DIS0_CLK_CTRL          ((PRCM_BASE) + 0xC4)
#define PRCM_DIS1_CLK_CTRL          ((PRCM_BASE) + 0xC8)
#define PRCM_I2S_CLK_CTRL           ((PRCM_BASE) + 0xCC)
#define PRCM_USB_CLK_CTRL           ((PRCM_BASE) + 0xD0)
#define PRCM_CORE_MEM_CLK_CTRL      ((PRCM_BASE) + 0xD4)
#define PRCM_GPIO_CORE_CLK_CTRL     ((PRCM_BASE) + 0xD8)
#define PRCM_TIMER_CORE_CLK_CTRL    ((PRCM_BASE) + 0xDC)
#define PRCM_WKUP_MEM_CLK_CTRL      ((PRCM_BASE) + 0xE0)
#define PRCM_GPIO_WKUP_CLK_CTRL     ((PRCM_BASE) + 0xE4)
#define PRCM_TIMER_WKUP_CLK_CTRL    ((PRCM_BASE) + 0xE8)
...
// PRCM_SYS_PWR_STATUS         
#define PRCM_SYS_PWR_STATUS_PLL_PWRDN_MASK                  (0x7F << 17)
...
#define PRCM_SYS_PWR_STATUS_NUSTAR_PWR_STATUS_MASK          (0x3F << 0)
...
//27.000MHz*2
#define PRCM_PLL_NR_54MHZ                                          1
#define PRCM_PLL_NF_54MHZ                                          72
#define PRCM_PLL_OD_54MHZ                                          16
#define PRCM_PLL_NB_54MHZ                                          36
...
extern int ns115_coresight_clk_enable(struct clk *clk);
extern int ns115_coresight_clk_disable(struct clk *clk);
extern int ns115_ddr_clk_enable(struct clk *clk);
extern int ns115_ddr_clk_disable(struct clk *clk);
extern int ns115_pl330dma_clk_enable(struct clk *clk);
extern int ns115_pl330dma_clk_disable(struct clk *clk);
extern int ns115_mali_clk_enable(struct clk *clk);
extern int ns115_mali_clk_disable(struct clk *clk);
extern int ns115_gc300_clk_enable(struct clk *clk);
extern int ns115_gc300_clk_disable(struct clk *clk);
extern int ns115_vpu_g1_clk_enable(struct clk *clk);
extern int ns115_vpu_g1_clk_disable(struct clk *clk);
extern int ns115_vpu_h1_clk_enable(struct clk *clk);
extern int ns115_vpu_h1_clk_disable(struct clk *clk);
extern int ns115_isp_jpeg_clk_enable(struct clk *clk);
extern int ns115_isp_jpeg_clk_disable(struct clk *clk);
extern int ns115_isp_clk_enable(struct clk *clk);
extern int ns115_isp_clk_disable(struct clk *clk);
extern int ns115_sd_clk_enable(struct clk *clk);
extern int ns115_sd_clk_disable(struct clk *clk);
extern int ns115_zsp_clk_enable(struct clk *clk);
extern int ns115_zsp_clk_disable(struct clk *clk);
extern int ns115_spi0_clk_enable(struct clk *clk);
extern int ns115_spi0_clk_disable(struct clk *clk);
extern int ns115_spi1_clk_enable(struct clk *clk);
extern int ns115_spi1_clk_disable(struct clk *clk);
extern int ns115_spi2_clk_enable(struct clk *clk);
extern int ns115_spi2_clk_disable(struct clk *clk);
extern int ns115_spi3_clk_enable(struct clk *clk);
extern int ns115_spi3_clk_disable(struct clk *clk);
extern int ns115_i2c0_clk_enable(struct clk *clk);
extern int ns115_i2c0_clk_disable(struct clk *clk);
extern int ns115_i2c1_clk_enable(struct clk *clk);
extern int ns115_i2c1_clk_disable(struct clk *clk);
extern int ns115_i2c2_clk_enable(struct clk *clk);
extern int ns115_i2c2_clk_disable(struct clk *clk);
extern int ns115_i2c3_clk_enable(struct clk *clk);
extern int ns115_i2c3_clk_disable(struct clk *clk);
extern int ns115_uart0_clk_enable(struct clk *clk);
extern int ns115_uart0_clk_disable(struct clk *clk);
extern int ns115_uart1_clk_enable(struct clk *clk);
extern int ns115_uart1_clk_disable(struct clk *clk);
extern int ns115_uart2_clk_enable(struct clk *clk);
extern int ns115_uart2_clk_disable(struct clk *clk);
extern int ns115_uart3_clk_enable(struct clk *clk);
extern int ns115_uart3_clk_disable(struct clk *clk);
extern int ns115_rgbo_clk_enable(struct clk *clk);
extern int ns115_rgbo_clk_disable(struct clk *clk);
extern int ns115_lcdc0_clk_enable(struct clk *clk);
extern int ns115_lcdc0_clk_disable(struct clk *clk);
extern int ns115_lcdc0_bus_clk_enable(struct clk *clk);
extern int ns115_lcdc0_bus_clk_disable(struct clk *clk);
extern int ns115_lcdc1_clk_enable(struct clk *clk);
extern int ns115_lcdc1_clk_disable(struct clk *clk);
extern int ns115_lcdc1_bus_clk_enable(struct clk *clk);
extern int ns115_lcdc1_bus_clk_disable(struct clk *clk);
extern int ns115_hdmi_pxl_clk_enable(struct clk *clk);
extern int ns115_hdmi_pxl_clk_disable(struct clk *clk);
extern int ns115_i2s0_clk_enable(struct clk *clk);
extern int ns115_i2s0_clk_disable(struct clk *clk);
extern int ns115_i2s1_clk_enable(struct clk *clk);
extern int ns115_i2s1_clk_disable(struct clk *clk);
extern int ns115_mclk_clk_enable(struct clk *clk);
extern int ns115_mclk_clk_disable(struct clk *clk);
extern int ns115_usb_otg_clk_enable(struct clk *clk);
extern int ns115_usb_otg_clk_disable(struct clk *clk);
extern int ns115_usb_utmi_clk_enable(struct clk *clk);
extern int ns115_usb_utmi_clk_disable(struct clk *clk);
extern int ns115_usb_ohci_clk_enable(struct clk *clk);
extern int ns115_usb_ohci_clk_disable(struct clk *clk);
extern int ns115_usb_hsic_clk_enable(struct clk *clk);
extern int ns115_usb_hsic_clk_disable(struct clk *clk);
extern int ns115_core_mem_clk_enable(struct clk *clk);
extern int ns115_core_mem_clk_disable(struct clk *clk);
extern int ns115_gpio_core_clk_enable(struct clk *clk);
extern int ns115_gpio_core_clk_disable(struct clk *clk);
extern int ns115_timer0_core_clk_enable(struct clk *clk);
extern int ns115_timer0_core_clk_disable(struct clk *clk);
extern int ns115_timer1_core_clk_enable(struct clk *clk);
extern int ns115_timer1_core_clk_disable(struct clk *clk);
extern int ns115_timer2_core_clk_enable(struct clk *clk);
extern int ns115_timer2_core_clk_disable(struct clk *clk);
extern int ns115_timer3_core_clk_enable(struct clk *clk);
extern int ns115_timer3_core_clk_disable(struct clk *clk);
extern int ns115_timer4_core_clk_enable(struct clk *clk);
extern int ns115_timer4_core_clk_disable(struct clk *clk);
extern int ns115_timer5_core_clk_enable(struct clk *clk);
extern int ns115_timer5_core_clk_disable(struct clk *clk);
extern int ns115_timer6_core_clk_enable(struct clk *clk);
extern int ns115_timer6_core_clk_disable(struct clk *clk);
extern int ns115_timer7_core_clk_enable(struct clk *clk);
extern int ns115_timer7_core_clk_disable(struct clk *clk);
extern int ns115_wkup_mem_clk_enable(struct clk *clk);
extern int ns115_wkup_mem_clk_disable(struct clk *clk);
extern int ns115_gpio_wkup_clk_enable(struct clk *clk);
extern int ns115_gpio_wkup_clk_disable(struct clk *clk);
extern int ns115_timer0_wkup_clk_enable(struct clk *clk);
extern int ns115_timer0_wkup_clk_disable(struct clk *clk);
extern int ns115_timer1_wkup_clk_enable(struct clk *clk);
extern int ns115_timer1_wkup_clk_disable(struct clk *clk);
extern int ns115_alt0_clk_enable(struct clk *clk);
extern int ns115_alt0_clk_disable(struct clk *clk);
extern int ns115_alt1_clk_enable(struct clk *clk);
extern int ns115_alt1_clk_disable(struct clk *clk);
extern int ns115_aux_clk_enable(struct clk *clk);
extern int ns115_aux_clk_disable(struct clk *clk);
extern int ns115_efuse_clk_enable(struct clk *clk);
extern int ns115_efuse_clk_disable(struct clk *clk);
extern int ns115_pwm_clk_enable(struct clk *clk);
extern int ns115_pwm_clk_disable(struct clk *clk);
extern int ns115_coresight_clk_set_rate(struct clk *c, unsigned long rate, unsigned int nouse);
extern int ns115_pll0_clk_set_rate(struct clk *c, unsigned long rate, unsigned int nouse);
extern int ns115_pll1_clk_set_rate(struct clk *c, unsigned long rate, unsigned int nouse);
extern int ns115_pll2_clk_set_rate(struct clk *c, unsigned long rate, unsigned int nouse);
extern int ns115_pll3_clk_set_rate(struct clk *c, unsigned long rate, unsigned int nouse);
extern int ns115_pll4_clk_set_rate(struct clk *c, unsigned long rate, unsigned int nouse);
extern int ns115_pll5_clk_set_rate(struct clk *c, unsigned long rate, unsigned int nouse);
extern int ns115_ddr_clk_set_rate(struct clk *c, unsigned long rate, unsigned int nouse);
extern int ns115_mali_pll2_set_rate(unsigned long rate);
extern int ns115_mali_clk_set_rate(struct clk *c, unsigned long rate, unsigned int nouse);
extern int ns115_gc300_clk_set_rate(struct clk *c, unsigned long rate, unsigned int nouse);
extern int ns115_vpu_g1_clk_set_rate(struct clk *c, unsigned long rate, unsigned int nouse);
extern int ns115_vpu_h1_clk_set_rate(struct clk *c, unsigned long rate, unsigned int nouse);
extern int ns115_isp_jpeg_clk_set_rate(struct clk *c, unsigned long rate, unsigned int nouse);
extern int ns115_sd_clk_set_rate(struct clk *c, unsigned long rate, unsigned int nouse);
extern int ns115_spi01_clk_set_rate(struct clk *c, unsigned long rate, unsigned int nouse);
extern int ns115_spi23_clk_set_rate(struct clk *c, unsigned long rate, unsigned int nouse);
extern int ns115_i2c_fs_clk_set_rate(struct clk *c, unsigned long rate, unsigned int nouse);
extern int ns115_i2c_hs_clk_set_rate(struct clk *c, unsigned long rate, unsigned int nouse);
extern int ns115_uart01_clk_set_rate(struct clk *c, unsigned long rate, unsigned int nouse);
extern int ns115_uart2_clk_set_rate(struct clk *c, unsigned long rate, unsigned int nouse);
extern int ns115_uart3_clk_set_rate(struct clk *c, unsigned long rate, unsigned int nouse);
extern int ns115_pxl0_clk_set_rate(struct clk *c, unsigned long rate, unsigned int nouse);
extern int ns115_pxl1_clk_set_rate(struct clk *c, unsigned long rate, unsigned int nouse);
extern int ns115_i2s_clk_set_rate(struct clk *c, unsigned long rate, unsigned int nouse);
extern int ns115_timer0_core_clk_set_rate(struct clk *c, unsigned long rate, unsigned int nouse);
extern int ns115_timer1_core_clk_set_rate(struct clk *c, unsigned long rate, unsigned int nouse);
extern int ns115_timer2_core_clk_set_rate(struct clk *c, unsigned long rate, unsigned int nouse);
extern int ns115_timer3_core_clk_set_rate(struct clk *c, unsigned long rate, unsigned int nouse);
extern int ns115_timer4_core_clk_set_rate(struct clk *c, unsigned long rate, unsigned int nouse);
extern int ns115_timer5_core_clk_set_rate(struct clk *c, unsigned long rate, unsigned int nouse);
extern int ns115_timer6_core_clk_set_rate(struct clk *c, unsigned long rate, unsigned int nouse);
extern int ns115_timer7_core_clk_set_rate(struct clk *c, unsigned long rate, unsigned int nouse);
extern int ns115_gpio_wkup_clk_set_rate(struct clk *c, unsigned long rate, unsigned int nouse);
extern int ns115_timer0_wkup_clk_set_rate(struct clk *c, unsigned long rate, unsigned int nouse);
extern int ns115_timer1_wkup_clk_set_rate(struct clk *c, unsigned long rate, unsigned int nouse);
extern int ns115_alt0_clk_set_rate(struct clk *c, unsigned long rate, unsigned int nouse);
extern int ns115_alt1_clk_set_rate(struct clk *c, unsigned long rate, unsigned int nouse);
extern int ns115_cpu_clk_set_rate(struct clk *c, unsigned long rate, unsigned int nouse);
