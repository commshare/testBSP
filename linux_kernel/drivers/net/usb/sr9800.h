#ifndef	__LINUX_USBNET_SR9800_H
#define	__LINUX_USBNET_SR9800_H
...
#define SR_SWRESET_IPOSC		0x0080
#define SR_SWRESET_IPPSL_0		0x0100
#define SR_SWRESET_IPPSL_1		0x0200
#define SR_SWRESET_IPCOPS		0x0400
#define SR_SWRESET_IPCOPSC		0x0800
#define SR_SWRESET_AUTODETACH		0x1000
#define SR_SWRESET_WOLLP		0x8000

#define SR9800_IPG0_DEFAULT		0x15
#define SR9800_IPG1_DEFAULT		0x16
#define SR9800_IPG2_DEFAULT		0x1A

#define SR9800_MEDIUM_FULL_DUPLEX	0x0002
#define SR9800_MEDIUM_RESERVED		0x0004
#define SR9800_MEDIUM_RX_FC_ENABLE	0x0010
#define SR9800_MEDIUM_TX_FC_ENABLE	0x0020
#define SR9800_                 MEDIUM_PAUSE_FORMAT	0x0080
#define SR9800_MEDIUM_RX_ENABLE	0x0100
#define SR9800_MEDIUM_100MB		0x0200
#define SR9800_MEDIUM_DEFAULT	\
	(SR9800_MEDIUM_FULL_DUPLEX | SR9800_MEDIUM_RX_FC_ENABLE | \
	 SR9800_MEDIUM_TX_FC_ENABLE | SR9800_MEDIUM_100MB | \
	 SR9800_MEDIUM_RESERVED | SR9800_MEDIUM_RX_ENABLE )
...
#define SR_CMD_WRITE_EEPROM_EN		0x0d
#define SR_CMD_WRITE_EEPROM_DIS		0x0e
...
#define SR_CMD_READ_NODE_ID		0x17
#define SR_CMD_READ_PHY_ID		0x19
#define SR_CMD_READ_MEDIUM_MODE		0x1a
...
#define SR_PHYSEL_PSEL		(1 << 0)
#define SR_PHYSEL_ASEL		(1 << 1)
#define SR_PHYSEL_SSMII		(0 << 2)
#define SR_PHYSEL_SSRMII	(1 << 2)
#define SR_PHYSEL_SSRRMII	(3 << 2)
#define SR_PHYSEL_SSEN		(1 << 4)
#define SR9800_CMD_READ_NODE_ID	0x13
#define SR9800_CMD_WRITE_NODE_ID	0x14
#define SR_CMD_READ_RXCOE_CTL		0x2b
#define SR_CMD_WRITE_RXCOE_CTL		0x2c
#define SR_CMD_READ_TXCOE_CTL		0x2d
#define SR_CMD_WRITE_TXCOE_CTL		0x2e

#define REG_LENGTH			2
#define PHY_ID_MASK			0x1f

#define SR_RXCOE_IPCE			0x0001
#define SR_RXCOE_IPVE			0x0002
#define SR_RXCOE_V6VE			0x0004
#define SR_RXCOE_TCPE			0x0008
#define SR_RXCOE_UDPE			0x0010
#define SR_RXCOE_ICMP			0x0020
#define SR_RXCOE_IGMP			0x0040
#define SR_RXCOE_ICV6			0x0080
#define SR_RXCOE_TCPV6			0x0100
#define SR_RXCOE_UDPV6			0x0200
#define SR_RXCOE_ICMV6			0x0400
#define SR_RXCOE_IGMV6			0x0800
#define SR_RXCOE_ICV6V6			0x1000
#define SR_RXCOE_FOPC			0x8000
#if LINUX_VERSION_CODE > KERNEL_VERSION(2,6,22)
#define SR_RXCOE_DEF_CSUM		(SR_RXCOE_IPCE | SR_RXCOE_IPVE | \
					 SR_RXCOE_V6VE | SR_RXCOE_TCPE | \
					 SR_RXCOE_UDPE |  SR_RXCOE_ICV6 | \
					 SR_RXCOE_TCPV6 | SR_RXCOE_UDPV6)
#else
#define SR_RXCOE_DEF_CSUM		(SR_RXCOE_IPCE | SR_RXCOE_IPVE | \
					 SR_RXCOE_TCPE | SR_RXCOE_UDPE)
#endif

#define SR_RXCOE_64TE			0x0100
#define SR_RXCOE_PPPOE			0x0200
#define SR_RXCOE_RPCE			0x8000

#define SR_TXCOE_IP			0x0001
#define SR_TXCOE_TCP			0x0002
#define SR_TXCOE_UDP			0x0004
#define SR_TXCOE_ICMP			0x0008
#define SR_TXCOE_IGMP			0x0010
#define SR_TXCOE_ICV6			0x0020

#define SR_TXCOE_TCPV6			0x0100
#define SR_TXCOE_UDPV6			0x0200
#define SR_TXCOE_ICMV6			0x0400
#define SR_TXCOE_IGMV6			0x0800
#define SR_TXCOE_ICV6V6			0x1000
#if LINUX_VERSION_CODE > KERNEL_VERSION(2,6,22)
#define SR_TXCOE_DEF_CSUM		(SR_TXCOE_TCP | SR_TXCOE_UDP | \
					 SR_TXCOE_TCPV6 | SR_TXCOE_UDPV6)
#else
#define SR_TXCOE_DEF_CSUM		(SR_TXCOE_TCP | SR_TXCOE_UDP)
#endif

#define SR_TXCOE_64TE			0x0001
#define SR_TXCOE_PPPE			0x0002
...
#define SR_RX_CTL_RH1M			0x0100		/* Enable RX-Header mode 0 */
#define SR_RX_CTL_RH2M			0x0200		/* Enable IP header in receive buffer aligned on 32-bit aligment */
#define SR_RX_CTL_RH3M			0x0400		/* checksum value in rx header 3 */
#define SR_RX_HEADER_DEFAULT		(SR_RX_CTL_RH1M | SR_RX_CTL_RH2M)

#define SR_RX_CTL_MFB			0x0300		/* Maximum Frame size 16384bytes */
#define SR_RX_CTL_START			0x0080		/* Ethernet MAC start */
#define SR_RX_CTL_AP			0x0020		/* Accept physcial address from Multicast array */
#define SR_RX_CTL_AM			0x0010	
#define SR_RX_CTL_AB			0x0008		/* Accetp Brocadcast frames*/
#define SR_RX_CTL_SEP			0x0004		/* Save error packets */	
#define SR_RX_CTL_AMALL			0x0002		/* Accetp all multicast frames */
#define SR_RX_CTL_PRO			0x0001		/* Promiscuous Mode */
#define SR_RX_CTL_STOP			0x0000		/* Stop MAC */
...
#define SR_MCAST_FILTER_SIZE		8
#define SR_MAX_MCAST			64
#define SR_INTERRUPT_BUFSIZE		8

#define SR_EEPROM_MAGIC 		0xdeadbeef
#define EEPROMMASK			0x7f

/* GPIO REGISTER */
#define SR_GPIOS_GPO0EN			0X01 // 1 << 0
#define SR_GPIOS_GPO0			0X02 // 1 << 1
#define SR_GPIOS_GPO1EN			0X04 // 1 << 2
#define SR_GPIOS_GPO1			0X08 // 1 << 3
#define SR_GPIOS_GPO2EN			0X10 // 1 << 4
#define SR_GPIOS_GPO2			0X20 // 1 << 5
#define SR_GPIOS_RSE			0X80 // 1 << 7

/* TX-header format */
#define SR_TX_HDR_CPHI			0x4000
#define SR_TX_HDR_DICF			0x8000
...
#define SR9800_WATCHDOG	 		(6 * HZ)

#define SR_RX_CHECKSUM		1
#define SR_TX_CHECKSUM		2
...
struct sr980x_int_data {
	u16 res1;
#define SR_INT_PPLS_LINK		(1 << 0)
#define SR_INT_SPLS_LINK		(1 << 1)
#define SR_INT_CABOFF_UNPLUG		(1 << 7)
	u8 link;
	u16 res2;
	u8 status;
	u16 res3;
...
#define SR_RXHDR_L4_ERR		(1 << 8)
#define SR_RXHDR_L3_ERR		(1 << 9)

#define SR_RXHDR_L4_TYPE_UDP		1
#define SR_RXHDR_L4_TYPE_ICMP		2
#define SR_RXHDR_L4_TYPE_IGMP		3
#define SR_RXHDR_L4_TYPE_TCP		4
#define SR_RXHDR_L4_TYPE_TCMPV6	5
#define SR_RXHDR_L4_TYPE_MASK	7

#define SR_RXHDR_L3_TYPE_IP		1
#define SR_RXHDR_L3_TYPE_IPV6		2

struct sr9800_rx_header {
...
static int sr98xx_read_cmd(struct usbnet *dev, u8 cmd, u16 value, u16 index,u16 size, void *data);
static int sr98xx_write_cmd(struct usbnet *dev, u8 cmd, u16 value, u16 index,u16 size, void *data);

#endif /* __LINUX_USBNET_SR9800_H */
