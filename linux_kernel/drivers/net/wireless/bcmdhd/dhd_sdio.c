...
const static char *bcm40183b2_fw_name[] = {
	"fw34_bcm53b2.bin",
        "fw34_bcm53b2_apsta.bin",
        "fw34_bcm53b2_p2p.bin",
        "fw34_bcm53b2_mfg.bin"
};
...
const static char *bcm40181a2_fw_name[] = {
	"fw34_bcm51a2.bin",
        "fw34_bcm51a2_apsta.bin",
        "fw34_bcm51a2_p2p.bin",
        "fw34_bcm51_mfg.bin"
};
...
#if 0
#ifdef CONFIG_WIFI_NW51
		pnv_path = "/system/etc/firmware/nvram_gb9662.txt";
#else
		pnv_path = "/system/etc/firmware/nvram_gb9663.txt";
#endif
#endif
		chip = bus->sih->chip;
		chiprev = bus->sih->chiprev;
		if(chip == BCM43362_CHIP_ID)
		{
			if(chiprev == BCM43362A2_CHIP_REV || chiprev == BCM43362A0_CHIP_REV)
				pnv_path = "/system/etc/firmware/nvram34_bcm51a2.txt";
		}
		if(chip == BCM4330_CHIP_ID && chiprev == BCM4330B2_CHIP_REV)
			pnv_path = "/system/etc/firmware/nvram34_bcm53b2.txt";
