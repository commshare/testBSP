...
static const struct usb_device_id option_ids[] = {
	...
	/*Add USB Mode Switch Support DEVICE*/
	{ USB_DEVICE(0x1E89, 0x1A20) }, // 1e89_f000
	{ USB_DEVICE(0x21F5, 0x2008) }, // 21f5_1000
	{ USB_DEVICE(0x05C6, 0x0015) }, // 05c6_2000
	{ USB_DEVICE(0x05C6, 0x9000) }, // 05c6_f000
	{ USB_DEVICE(0x05C6, 0x00A0) }, // 05c6_0010
	{ USB_DEVICE(0x028A, 0x1006) }, // 05c6_1000
	{ USB_DEVICE(0x04E8, 0x6601) }, // 05c6_1000_uMa.SAMSUNG
	{ USB_DEVICE(0x1004, 0x6124) }, // 1004_613a
	{ USB_DEVICE(0x1004, 0x6141) }, // 004_613f
	{ USB_DEVICE(0x1004, 0x61A7) }, // 1004_6190
	{ USB_DEVICE(0x1004, 0x6114) }, // 1004_607f
	{ USB_DEVICE(0x1ee8, 0x0012) }, // 1ee8_0013
	{ USB_DEVICE(0x1ee8, 0x003e) }, // 1ee8_0040
	{ USB_DEVICE(0x0421, 0x060e) }, // 0421_060c
	{ USB_DEVICE(0x0421, 0x0612) }, // 0421_0610
	{ USB_DEVICE(0x0421, 0x0623) }, // 0421_0622
	{ USB_DEVICE(0x1dbc, 0x0005) }, // 0471_1210
	{ USB_DEVICE(0x0471, 0x1206) }, // 0471_1237
	{ USB_DEVICE(0x0471, 0x1234) }, // 0471_1237
	{ USB_DEVICE(0x04cc, 0x2259) }, // 04cc_2251
	{ USB_DEVICE(0x04e8, 0x6601) }, // 04e8_f000
	{ USB_DEVICE(0x057c, 0x8401) }, // 057c_84ff
	{ USB_DEVICE(0x057c, 0x6000) }, // 05c7_1000
	{ USB_DEVICE(0x072f, 0x90cc) }, // 072f_100d
	{ USB_DEVICE(0x07d1, 0x3e02) }, // 07d1_a800
	{ USB_DEVICE(0x07d1, 0x7e11) }, // 07d1_a804
	{ USB_DEVICE(0x0b3c, 0xc001) }, // 0b3c_c700
	{ USB_DEVICE(0x0b3c, 0xc002) }, // 0b3c_c700
	{ USB_DEVICE(0x0b3c, 0xc003) }, // 0b3c_f000
	{ USB_DEVICE(0x0b3c, 0xc004) }, // 0b3c_f000
	{ USB_DEVICE(0x0cf3, 0x7010) }, // 0cf3_20ff
	{ USB_DEVICE(0x0d46, 0x45a9) }, // 0d46_45a1
	{ USB_DEVICE(0x0d46, 0x45ad) }, // 0d46_45a5
	{ USB_DEVICE(0x0e8d, 0x7118) }, // 0e8d_7109
	{ USB_DEVICE(0x106c, 0x3715) }, // 106c_3b03
	{ USB_DEVICE(0x106c, 0x3716) }, // 106c_3b05
	{ USB_DEVICE(0x106c, 0x3717) }, // 106c_3b06
	{ USB_DEVICE(0x1076, 0x7f00) }, // 1076_7f40
	{ USB_DEVICE(0x1199, 0x0017) }, // 1199_0fff
	{ USB_DEVICE(0x1199, 0x0018) }, // 1199_0fff
	{ USB_DEVICE(0x1199, 0x0019) }, // 1199_0fff
	{ USB_DEVICE(0x1199, 0x0020) }, // 1199_0fff
	{ USB_DEVICE(0x1199, 0x0021) }, // 1199_0fff
	{ USB_DEVICE(0x1199, 0x0022) }, // 1199_0fff
	{ USB_DEVICE(0x1199, 0x0024) }, // 1199_0fff
	{ USB_DEVICE(0x1199, 0x0026) }, // 1199_0fff
	{ USB_DEVICE(0x1199, 0x0027) }, // 1199_0fff
	{ USB_DEVICE(0x1199, 0x0028) }, // 1199_0fff
	{ USB_DEVICE(0x1199, 0x0029) }, // 1199_0fff
	{ USB_DEVICE(0x1199, 0x0112) }, // 1199_0fff
	{ USB_DEVICE(0x1199, 0x0120) }, // 1199_0fff
	{ USB_DEVICE(0x1199, 0x0218) }, // 1199_0fff
	{ USB_DEVICE(0x1199, 0x0220) }, // 1199_0fff
	{ USB_DEVICE(0x1199, 0x0224) }, // 1199_0fff
	{ USB_DEVICE(0x1199, 0x6802) }, // 1199_0fff
	{ USB_DEVICE(0x1199, 0x6803) }, // 1199_0fff
	{ USB_DEVICE(0x1199, 0x6804) }, // 1199_0fff
	{ USB_DEVICE(0x1199, 0x6805) }, // 1199_0fff
	{ USB_DEVICE(0x1199, 0x6808) }, // 1199_0fff
	{ USB_DEVICE(0x1199, 0x6809) }, // 1199_0fff
	{ USB_DEVICE(0x1199, 0x6812) }, // 1199_0fff
	{ USB_DEVICE(0x1199, 0x6813) }, // 1199_0fff
	{ USB_DEVICE(0x1199, 0x6815) }, // 1199_0fff
	{ USB_DEVICE(0x1199, 0x6816) }, // 1199_0fff
	{ USB_DEVICE(0x1199, 0x6820) }, // 1199_0fff
	{ USB_DEVICE(0x1199, 0x6821) }, // 1199_0fff
	{ USB_DEVICE(0x1199, 0x6822) }, // 1199_0fff
	{ USB_DEVICE(0x1199, 0x6832) }, // 1199_0fff
	{ USB_DEVICE(0x1199, 0x6833) }, // 1199_0fff
	{ USB_DEVICE(0x1199, 0x6834) }, // 1199_0fff
	{ USB_DEVICE(0x1199, 0x6835) }, // 1199_0fff
	{ USB_DEVICE(0x1199, 0x6838) }, // 1199_0fff
	{ USB_DEVICE(0x1199, 0x6839) }, // 1199_0fff
	{ USB_DEVICE(0x1199, 0x683a) }, // 1199_0fff
	{ USB_DEVICE(0x1199, 0x683b) }, // 1199_0fff
	{ USB_DEVICE(0x1199, 0x683c) }, // 1199_0fff
	{ USB_DEVICE(0x1199, 0x683d) }, // 1199_0fff
	{ USB_DEVICE(0x1199, 0x683e) }, // 1199_0fff
	{ USB_DEVICE(0x1199, 0x6850) }, // 1199_0fff
	{ USB_DEVICE(0x1199, 0x6851) }, // 1199_0fff
	{ USB_DEVICE(0x1199, 0x6852) }, // 1199_0fff
	{ USB_DEVICE(0x1199, 0x6853) }, // 1199_0fff
	{ USB_DEVICE(0x1199, 0x6855) }, // 1199_0fff
	{ USB_DEVICE(0x1199, 0x6856) }, // 1199_0fff
	{ USB_DEVICE(0x1199, 0x6859) }, // 1199_0fff
	{ USB_DEVICE(0x1199, 0x685a) }, // 1199_0fff
	{ USB_DEVICE(0x148f, 0x9021) }, // 148f_2578
	{ USB_DEVICE(0x15eb, 0x7152) }, // 15eb_7153
	{ USB_DEVICE(0x16d8, 0x6006) }, // 16d8_f000
	{ USB_DEVICE(0x198a, 0x0002) }, // 198a_0003
	{ USB_DEVICE(0x198f, 0x0220) }, // 198f_bccd
	{ USB_DEVICE(0x19f5, 0x9905) }, // 19f5_9905
	{ USB_DEVICE(0x19f5, 0x9909) }, // 19f5_9909
	{ USB_DEVICE(0x19f5, 0x9013) }, // 19f5_f000
	{ USB_DEVICE(0x1ab7, 0x2000) }, // 1ab7_5700
	{ USB_DEVICE(0x1b7d, 0x0001) }, // 1b7d_0700
	{ USB_DEVICE(0x1c9e, 0x6061) }, // 1c9e_1001
	{ USB_DEVICE(0x1c9e, 0x9202) }, // 1c9e_9200
	{ USB_DEVICE(0x1c9e, 0x9000) }, // 1c9e_f000
	{ USB_DEVICE(0x1c9e, 0x9605) }, // 1c9e_f000
	{ USB_DEVICE(0x1c9e, 0x9607) }, // 1c9e_f000
	{ USB_DEVICE(0x1c9e, 0x9202) }, // 1c9e_f000
	{ USB_DEVICE(0x1e0e, 0x9000) }, // 1e0e_f000
	{ USB_DEVICE(0x1dd6, 0x1002) }, // 1dd6_1000
	{ USB_DEVICE(0x1f28, 0x0020) }, // 1f28_0021
	{ USB_DEVICE(0x1fac, 0x0131) }, // 1fac_0130
	{ USB_DEVICE(0x2020, 0x1005) }, // 2020_f00e
	{ USB_DEVICE(0x2020, 0x1008) }, // 2020_f00e
	{ USB_DEVICE(0x20a6, 0x1105) }, // 20a6_1000
	{ USB_DEVICE(0x20a6, 0x1008) }, // 20a6_f00a
	{ USB_DEVICE(0x20b9, 0x1682) }, // 20b9_1682
	{ USB_DEVICE(0x16d8, 0x6533) }, // 8888_6500
	{ USB_DEVICE(0x12d1, 0x1506) }, // 12d1_14fe
	{ } /* Terminating entry */
};
