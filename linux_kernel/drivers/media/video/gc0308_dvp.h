...
struct gc0308_format_struct;	/* coming later */
struct gc0308_info {
	struct gc0308_format_struct *fmt;	/* Current format */
...
static struct regval_list gc0308_fmt_yuv422_vga[] = {
	{0xfe, 0x01},
	{0x54, 0x11},
	{0x55, 0x03},
	{0x56, 0x00},
	...
	{0xfe, 0x00},
	{0x46, 0x00},		//disable crop window mode
	{0x47, 0x00},
	{0x48, 0x00},
	{0x49, 0x01},
	{0x4a, 0xe0},		//480
...
static struct regval_list gc0308_fmt_yuv422_qvga[] = {
	{0xfe, 0x01},
