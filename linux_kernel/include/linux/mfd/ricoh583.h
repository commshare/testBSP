...
struct ricoh583_pwrkey_platform_data {
	int irq;
...
struct ricoh583_gpio_init_data {
	...
	unsigned ext_pwr_req;
	unsigned deepsleep_slots;
};
...
extern int ricoh583_suspend_system(void);
extern void ricoh583_power_off(void);
extern void ricoh583_restart(char str, const char * cmd);

enum ns115_charger_type;
extern void ricoh583_charger_plug(enum ns115_charger_type type);
extern void ricoh583_charger_unplug(void);
