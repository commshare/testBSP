...
static struct rt5616_init_reg init_list[] = {
	...
	{RT5616_LOUT_CTRL1	, 0xd0d0}, //line output vol
	/*HP*/
	//{RT5616_HPO_MIXER	, 0x2000}, //DAC -> HPO
	{RT5616_HPO_MIXER	, 0x4000}, //HPVOL -> HPO
	{RT5616_HP_VOL		, 0x1010}, //unmute HPVOL
	{RT5616_OUT_L3_MIXER	, 0x0378}, //DACL1 -> OUTMIXL
	{RT5616_OUT_R3_MIXER	, 0x0378}, //DACR1 -> OUTMIXR
	/*LOUT*/
	{RT5616_LOUT_MIXER	, 0x3000},
	/*Capture*/
	{RT5616_REC_L2_MIXER	, 0x606d}, //MIC1 -> RECMIXL
	{RT5616_REC_R2_MIXER	, 0x606d}, //MIC1 -> RECMIXR
//	{RT5616_REC_L2_MIXER	, 0x00eb}, //MIC2 -> RECMIXL
//	{RT5616_REC_R2_MIXER	, 0x00eb}, //MIC2 -> RECMIXR
	{RT5616_ADC_DIG_VOL	, 0xffff}, //MIC vol & mute adc for pop noise
	/*MIC*/
	{RT5616_STO1_ADC_MIXER	, 0x3802},

	{RT5616_IN1_IN2		, 0x0000}, //bypass
	{RT5616_REC_L1_MIXER , 0x0006},//bst2 vol -9db
    {RT5616_REC_R1_MIXER , 0x0006},//bst2 vol -9db

//    {RT5616_JD_CTRL2		, 0x0200},//jd detect sta_jd1_1
//    {RT5616_JD_CTRL1		, 0x0c08}

//    {RT5616_PWR_ANLG2		, 0x0800} //micbias power on
};
...
static const u16 rt5616_reg[RT5616_DEVICE_ID + 1] = {
	...
	[RT5616_OUT_L3_MIXER] = 0x0379,
 	[RT5616_OUT_R3_MIXER] = 0x0379,
	...
	struct snd_kcontrol *kcontrol, int event)
{
    ...
    dev_dbg(codec->dev, "enter %s event = %d\n",__func__,event);
	switch (event) {
...
int rt5616_codec_digital_mute(struct snd_soc_dai *codec_dai, int mute)
{
    struct snd_soc_codec *codec = codec_dai->codec;
    dev_dbg(codec->dev, "enter %s level = %d\n",__func__,mute);
    if (mute)
    {
    }
    else
